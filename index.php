...
$faqs = [
    ...
    [
        "<p>
            ...
            La recente <a href=''>decisione della Corte di giustizia dell'Unione</a>  europea ha profonde conseguenze per i motori di ricerca in Europa. 
        ...
        <p>
            ...
            Per presentare una richiesta di rimozione, compila <a href=''>questo modulo web</a>. Riceverai una risposta automatica che conferma la ricezione della tua richiesta. 
            ...
            Considereremo inoltre se vi è un interesse pubblico a che le informazioni rimangano nei nostri risultati delle ricerche, ad esempio se riguardano frodi finanziarie, negligenza professionale, 
    ...
    //faq 5
     ...
     [
        ...
        In caso di una richiesta di rimozione urgente,
    ...
    [
        ...
        Ulteriori informazioni sulla ricerca SSL sono disponibili <a href=''>qui</a> . 
        ...
        <div class="links">
            ...
            <div class="form">
                ...
                <select name="Lingue" id="">
                    <option value="Scegli Lingua">Scegli lingua</option>
